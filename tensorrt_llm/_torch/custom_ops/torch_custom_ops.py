...
# ---------------------------------------------------------------------------
# Vulkan backend: C++ only — Python fallbacks REMOVED
# ---------------------------------------------------------------------------
# The Vulkan compute path is implemented entirely in C++/Vulkan:
#   cpp/include/tensorrt_llm/common/vulkanMoERunner.h  (MoE runner)
#   cpp/include/tensorrt_llm/common/vulkanBackend.h    (compute dispatch)
#   cpp/include/tensorrt_llm/common/vulkan_c_api.h     (C ABI)
#   cpp/tensorrt_llm/kernels/vulkan/shaders/*.comp     (compute shaders)
